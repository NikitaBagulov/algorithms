...
def get_spanning_tree(graph): #гениальная реализация функции, 10 из 10!
    result  = nx.minimum_spanning_tree(graph, "prim")
    return result


def split_to_forests(graph, n=40):
